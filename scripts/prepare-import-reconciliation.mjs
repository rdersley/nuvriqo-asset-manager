...
else if(!src.includes('asset?.jiraAliases')) console.warn('CSV reconciliation: ticket-history alias patch not applied; continuing with reconciliation resolvers.');
...
else if(!src.includes('mergedTickets=new Map()')) console.warn('CSV reconciliation: report alias patch not applied; continuing with reconciliation resolvers.');
