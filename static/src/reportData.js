...
const BATCH = 100;
const CONCURRENCY = 4;
// 400 pages of 100 = 40,000 assets before a report is marked partial.
const MAX_ASSET_PAGES = 400;
...
export async function loadFullReport(onProgress) {
  ...
  let pages = 0;
  do {
    const page = await invoke('listAssetsPage', { cursor, limit: BATCH, maxScanPages: 1 });
